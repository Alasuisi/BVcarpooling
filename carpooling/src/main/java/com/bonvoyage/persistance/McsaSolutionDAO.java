...
public static LinkedList<McsaSolution> searchSolutions(Transfer toSearch,long timeFrame,int limitSolution) throws IOException
	{
...
public static LinkedList<McsaSolution> readComputedSolutions(int userid,int transferid) throws JsonParseException, JsonMappingException, IOException
	{
	Client client = Client.create();
	ObjectMapper mapper = new ObjectMapper();
